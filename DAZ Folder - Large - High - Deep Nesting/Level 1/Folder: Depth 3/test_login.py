...
class TestLoginPage:
    def test_institutional_login(self, driver, login_page):
        ...
        login_page.select_institution_login()
        institutional_login_page = InstitutionalLoginPage(driver, verify=True)
        assert len(institutional_login_page.dropdown_options) > 0
    ...
    def test_need_help_link(self, driver, login_page):
        ...
        time.sleep(5)
        assert 'https://help.osf.io' in driver.current_url
    ...
    def test_individual_institution_login_pages(
        ...
        for institution in institution_list:
            ...
            WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable((By.ID, 'institutionSelect'))
            )
            ...
            option = WebDriverWait(driver, 10).until(
                EC.element_to_be_clickable(
                    (
                        By.XPATH,
                        f"//select[@id='institutionSelect']/option[normalize-space(text())='{institution}']",
                    )
                )
            )
            option.click()
            ...
            institution_login_page.sign_in_button_institutions.click()
